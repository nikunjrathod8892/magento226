 ...
 */
namespace Lof\HidePrice\Block\Adminhtml\Quote\Renderer;
use Magento\Framework\UrlInterface;

class QuoteAction extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Text
{
	/**
