 ...
 */
namespace Lof\HidePrice\Block\Adminhtml\Quote;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Lof_HidePrice::quote_delete')) {
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('lofhideprice_form')->getId()) {
            return __("Edit Message '%1'", $this->escapeHtml($this->_coreRegistry->registry('lofhideprice_quote')->getTitle()));
        } else {
     ...
     protected function _getJsInitScripts()
    {
        ...
        $editUrl = $this->getUrl(
            'lofhideprice/quote/sendemail' 
        );
        $setEmailUrl = $this->getUrl('lofhideprice/quote/setemail');
          return "
        <script>
