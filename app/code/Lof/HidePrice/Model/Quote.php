...
class Quote extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function __construct(
        ...
        \Lof\HidePrice\Model\ResourceModel\Quote $resource = null,
        \Lof\HidePrice\Model\ResourceModel\Quote\Collection $resourceCollection = null,
        array $data = []
        ) {
    ...
    {
        $this->_init('Lof\HidePrice\Model\ResourceModel\Quote');
    }
}