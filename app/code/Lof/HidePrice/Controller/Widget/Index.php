...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute() {
        ...
        if($data){
            ...
            if(isset($data['town'])) {
                $message_data['town']         = $data['town'];
            }
            if(isset($data['post_code'])) {
                $message_data['post_code']    = $data['post_code'];
            }
            if(isset($data['company_name'])) {
                $message_data['company_name'] = $data['company_name'];
            }
            if(isset($data['email'])) {
            ...
            try {
                ...
                if (!\Zend_Validate::is(trim($data['town']), 'NotEmpty')) {
                    $error = true;
                }

                if (!\Zend_Validate::is(trim($data['post_code']), 'NotEmpty')) {
                    $error = true;
                }
