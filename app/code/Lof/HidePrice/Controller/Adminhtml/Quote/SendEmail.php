...
namespace Lof\HidePrice\Controller\Adminhtml\Quote;
...
{   
    ...
    public function __construct(
        ...
        \Lof\HidePrice\Model\Quote $message,
    ...
    { 
        ...
        $arg['first_name'] = $data["first_name"];
        $arg['last_name'] = $data["last_name"];
            ...
            try{
                ...
                $this->transportBuilder
                    ...
                    [
                     ...
                     $this->transportBuilder->addTo($data['email'],$data['first_name']);
