...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Brainvire_Vendor::attachment_save');
    }*/
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('bv_vendor', $model);
        ...
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getTitle() : __('New Vendor'));
